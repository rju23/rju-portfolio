...
void main() {
  ...
  `,a.style.position=`absolute`,a.style.right=`20px`,a.style.top=`420px`,a.style.padding=`12px`,a.style.background=`rgba(0, 0, 0, 0.8)`,a.style.color=`white`,a.style.fontFamily=`Arial`,a.style.fontSize=`14px`,a.style.lineHeight=`1.5`,e.appendChild(a);let o=document.createElement(`div`);o.innerHTML=`
    <div>
  ...
  `,o.style.position=`absolute`,o.style.left=`20px`,o.style.bottom=`20px`,o.style.padding=`12px`,o.style.background=`rgba(0, 0, 0, 0.8)`,o.style.color=`white`,o.style.fontFamily=`Arial`,o.style.fontSize=`14px`,o.style.lineHeight=`1.5`,e.appendChild(o);let s=document.createElement(`div`);s.textContent=`Phase 4: Pacemaker depolarization`,s.style.position=`absolute`,s.style.right=`20px`,s.style.bottom=`20px`,s.style.padding=`14px 18px`,s.style.background=`rgba(0, 0, 0, 0.8)`,s.style.color=`white`,s.style.fontFamily=`Arial`,s.style.fontSize=`18px`,s.style.fontWeight=`bold`,e.appendChild(s);let c=document.createElement(`div`);c.textContent=`cAMP: baseline`,c.style.position=`absolute`,c.style.left=`50%`,c.style.bottom=`20px`,c.style.transform=`translateX(-50%)`,c.style.padding=`10px 16px`,c.style.background=`rgba(0, 0, 0, 0.8)`,c.style.color=`white`,c.style.fontFamily=`Arial`,c.style.fontSize=`16px`,e.appendChild(c);let l=document.createElement(`div`);l.textContent=`Heart rate: 75 bpm`,l.style.position=`absolute`,l.style.right=`20px`,l.style.top=`300px`,l.style.padding=`10px 14px`,l.style.background=`rgba(0, 0, 0, 0.8)`,l.style.color=`white`,l.style.fontFamily=`Arial`,l.style.fontSize=`16px`,e.appendChild(l);let u=document.createElement(`div`);u.textContent=`Normal pacemaker rate`,u.style.position=`absolute`,u.style.right=`20px`,u.style.top=`330px`,u.style.padding=`8px 12px`,u.style.background=`rgba(0, 0, 0, 0.7)`,u.style.color=`white`,u.style.fontFamily=`Arial`,u.style.fontSize=`14px`,e.appendChild(u);let d=document.createElement(`div`);d.innerHTML=`
